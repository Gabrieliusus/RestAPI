...
namespace TestSchool
{
    ...
    public class SchuleTests
    {
        ...
        [Test]
        public void AddSchuelerToSchule_TryToAddSchuelerWithWrongGender_ReturnsCorrectSchuelerCount()
        {
            Schule schule = new Schule();
            Schueler schueler1 = new Schueler("10A", new DateTime(2005, 06, 15), "mnnlich");

            schule.AddSchuelerToSchule(schueler1);

            Assert.IsTrue(String.IsNullOrEmpty(schueler1.Geschlecht));
        }
        [Test]
